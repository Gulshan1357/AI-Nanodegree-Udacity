...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        layers.ActionNode
        """
        for effA in actionA.effects:
            if ~effA in actionB.effects:
                return True
        for effB in actionB.effects:
            if ~effB in actionA.effects:
                return True
        return False
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        for effA in actionA.effects:
            if ~effA in actionB.preconditions:
                return True
        for effB in actionB.effects:
            if ~effB in actionA.preconditions:
                return True
        return False
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        if not actionA.preconditions or not actionB.preconditions or actionA.preconditions == actionB.preconditions: # not null or identical
            return False
...
class PlanningGraph:
    ...
    def h_levelsum(self):
        ...
        for goal in self.goal:
            costsum.append(self.levelCost(goal))
        return sum(costsum)
